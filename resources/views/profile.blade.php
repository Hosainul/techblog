                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <a class="avatar" href="{{ route('author.profile',$post->user->username) }}"><img src="{{ Storage::disk('public')->url('public/'.$post->user->image) }}" alt="Profile Image"></a>
            ...
            <div class="col-lg-4 col-md-12 ">
                ...
                <div class="single-post info-area ">
                    ...
                    <div class="about-area">
                        ...
                        <strong>Author Posts: {{ $author->posts->count() }}</strong>
                    </div>
