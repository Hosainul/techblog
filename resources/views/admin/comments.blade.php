                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href=""><img src="{{Storage::disk('public')->url('public/'.$comment->user->image)}}"
                                                        class="media-object" width="64" height="64" alt=""></a>
                                                </div>
                                            ...
                                            <div class="media">
                                                <div class="media-right">
                                                    <a href="{{route('post.details',$comment->post->slug)}}">
                                                        <img src="{{Storage::disk('public')->url('post/'.$comment->post->image)}}" class="media-object" width="64" height="64">
                                                    </a>
                                                </div>
                                                <div class="media-body">
